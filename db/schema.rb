...
ActiveRecord::Schema.define(version: 2020_08_21_090335) do
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "content"
    t.index ["cake_id"], name: "index_requests_on_cake_id"
  ...
  add_foreign_key "requests", "cakes"
